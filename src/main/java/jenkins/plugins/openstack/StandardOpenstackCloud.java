...
public class StandardOpenstackCloud extends OpenstackCloud {
    ...
    public StandardOpenstackCloud(String id, URL authUrl, String accessId, String tenant, String secretKey, String sshPublicKey, String sshPrivateKey, String instanceCapStr, List<SlaveTemplate> templates) throws IOException {
        super(id, authUrl, accessId, tenant, secretKey, sshPublicKey, sshPrivateKey, instanceCapStr, templates);
    }
